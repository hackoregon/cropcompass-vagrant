...
The Django code lives offline in the GitHub repo <https://github.com/hackoregon/cropcompass-vagrant/tree/django-offboard>. During the provisioning step a `git clone` fetches this to `~vagrant`, where the nginx / uWSGI configuration expects to find it. As part of this process, the static files are collected.
